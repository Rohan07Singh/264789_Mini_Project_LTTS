...
![Description](https://github.com/Rohan07Singh/264789_Mini_Project_LTTS.git/blob/main/6_Media/flow.png?raw=true)
### Explanation:
...
## SWOT ANALYSIS
![SWOT Analysis](https://github.com/Rohan07Singh/264789_Mini_Project_LTTS.git/blob/main/6_Media/swot.png?raw=true)
...
| LR08 | If the total number of moves, i.e., 9 moves have been completed and neither the user nor the computer has won, it'll end up in a draw. | HR06 |
